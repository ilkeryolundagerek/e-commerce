...
namespace ECommerce.Areas.Dashboard.Controllers
{
    ...
    public class CategoriesController : BaseController
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Description,Active,Deleted,CreateDate")] Category category)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Description,Active,Deleted,CreateDate")] Category category)
        {
            if (id != category.Id)
            {
                return NotFound();
